...
//     return this.http.post(`${this.apiUrl}/positivity`, formData, { responseType: 'text' });
//   }
...
//   const formData = new FormData();
//   formData.append('file', file);
//   return this.http.post(`${this.apiUrl}/volume`, formData, { responseType: 'text' });
// }
// }
